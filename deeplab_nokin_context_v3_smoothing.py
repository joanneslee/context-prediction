        ...
        for Trial in FilenamesInTask:
            ...
            for root, dirs, files in os.walk(TrialRoot):
                for folder in dirs:
                    ...
                    TrialLabelRoot = os.path.join(TrialRoot, folder)
                    ...
                    for root, dirs, files in os.walk(TrialLabelRoot):
                        ...
                        for file in files:
                            ...
                            threadRoot = os.path.join(TrialRoot, "deeplab_thread_v3", trialFname)
                            ...
                            ''' #what is the difference between this and the thread contours??
                            SingleThreadX = []
                            SingleThreadY = []
                            ...
                            if("Suturing" in self.task):
                                ...
                                ctxPredLine, LG_inter_T, RG_inter_T, messages = self.GenerateContextLineSPred(pred, needleShape, L_Gripping, R_Gripping, frameNumber, contextLines, pred_bisector, pred_tissue, Bisector)
